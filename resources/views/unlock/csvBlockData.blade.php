...
@section('content')
    ...
    <h2>Ilość telefonów do zablokowania w pliku: {{count($dane)}}</h2>
    ...
    <div class="btn-group">
        <button id='pobierz' type="button" class="btn btn-primary">Zablokuj rekordy</button>
    </div>
    <div id="status">
